export function CheckIcon({ className = "w-4 h-4 text-neutral-700" }: { className?: string }) {
  return (
...
// Structural grid intersection tick (T-bar decoration matching the reference layout)
export function GridTick({ position }: { position: "top-left" | "top-right" | "bottom-left" | "bottom-right" }) {
